declare module "smoothie" {
  ...
  export class TimeSeries {
     ...
     * <code>SmoothieChart.addTimeSeries</code>.
     */
     ...
     * @param sumRepeatedTimeStampValues if <code>timestamp</code> has an exact match in the series,
     * this flag controls
  ...
  export interface IChartOptions {
    ...
    /** Optional function to format time stamps for bottom of chart. You may use
     * <code>SmoothieChart.timeFormatter</code>, or your own/ */
  ...
  export class SmoothieChart {
     ...
     *
     * As you may use a single <code>TimeSeries</code> in multiple charts with different formatting
     * in each usage,
    ...
    /**
     * Brings the specified <code>TimeSeries</code> to the top of the chart. It will be rendered
     * last.
     */
    bringToFront(timeSeries: TimeSeries): void;

    /**
     * Instructs the <code>SmoothieChart</code> to start rendering to the provided canvas, with
     * specified delay.
     *
     * @param canvas the target canvas element
     * @param delayMillis an amount of time to wait before a data point is shown. This can prevent
